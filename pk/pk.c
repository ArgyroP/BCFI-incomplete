...
static void run_loaded_program(size_t argc, char** argv, uintptr_t kstack_top)
{
  ...
  //SHADOW STACK MAPPING
  uintptr_t shadow_stack_vaddr = 0x4000000000;
  shadow_stack_bottom = __do_mmap(shadow_stack_vaddr, stack_size, PROT_READ|PROT_WRITE|PROT_EXEC| PROT_SHADOW, MAP_PRIVATE|MAP_ANONYMOUS|MAP_FIXED|MAP_SHADOW_STACK, 0, 0);
